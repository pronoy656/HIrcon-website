  ...
  return (
    <div 
      ...
      className={clsx(
        ...
        isSelected 
          ? "bg-[#5A54F9] border-transparent shadow-lg scale-[1.01] z-10 text-white" 
    ...
    >
      <div className={clsx("grid grid-cols-[1.5fr_1fr_1fr_1fr_1.4fr_1.4fr_0.8fr_1fr_1.3fr_1.3fr] w-full divide-x", isSelected ? "divide-white/20" : "divide-gray-100")}>
        ...
        <div className="flex items-center gap-3 px-3 min-w-0">
          <div className={clsx("w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 shadow-md", isSelected ? "bg-white text-[#5A54F9]" : "bg-[#081b4c] text-white")}>
