...
export function QuickShipForm() {
  ...
  return (
    <div className="flex flex-col gap-8 animate-in fade-in duration-500 pb-12">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-extrabold text-gray-900 mb-2 tracking-tight">Quick Ship</h1>
        <p className="text-gray-500 font-medium">Create a new quick shipment request.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 relative">
          ...
          <InputField 
            ...
            tooltip="Please add a short description of your package contents, this will be added to your label. An extended description that exceeds the available space on the label can be produced by simply adding more characters. This additional label will be available for printing at the end of the shipment process or in your Tracking History." 
          />
          <InputField 
