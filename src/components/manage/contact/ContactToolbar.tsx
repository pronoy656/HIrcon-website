    ...
    <div className="p-4 border-b border-gray-100 flex flex-wrap lg:flex-nowrap items-center justify-between gap-4 bg-gray-50/50">
      <div className="relative max-w-md w-full">
        ...
        <input 
          ...
          className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0b215f]/20 focus:border-[#0b215f] transition-all bg-white font-medium text-sm"
        />
      </div>
