          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center justify-between mt-2">
              <div className="flex items-center gap-2">
                <input type="checkbox" id="remember" className="rounded border-gray-300 text-[#081b4c] focus:ring-[#081b4c] w-4 h-4 cursor-pointer" />
                <label htmlFor="remember" className="text-sm text-gray-600 cursor-pointer">Remember me for 30 days</label>
              </div>
              <Link href="/auth/forgot-password" className="text-sm font-semibold text-[#081b4c] hover:underline">
                Forgot Password?
              </Link>
            </div>
          </div>

          <Button type="submit" className="h-14 mt-4 w-full bg-[#081b4c] hover:bg-[#0a205a] text-lg rounded-xl">
            Sign In
          </Button>
        </form>

        <p className="mt-8 text-center text-gray-600">
          New here? <Link href="/auth/register" className="text-[#081b4c] font-semibold hover:underline">Sign Up</Link>
        </p>
      </div>
    </AuthLayout>
  );
