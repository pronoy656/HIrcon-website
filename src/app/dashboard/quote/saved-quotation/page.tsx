...
const MOCK_SERVICES: MockService[] = [
  { id:"1", carrier:"Royal Mail", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://royalmail.com&size=128", serviceName:"Tracked 48", serviceCode:"RM-T48", category:"economy-standard", deliveryDays:"2-3 days", price:4.99, currency:"GBP", features:["Tracked","Signature on delivery","Up to 20kg"], rating:4.1, isBestValue:true, color:"#C8102E", collectionType:"Drop-off", transitType:"By Ship" },
  { id:"2", carrier:"Hermes", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://evri.com&size=128", serviceName:"Standard Parcel", serviceCode:"HE-STD", category:"economy-standard", deliveryDays:"3-5 days", price:3.49, currency:"GBP", features:["Tracked","Safe place options","Up to 15kg"], rating:3.8, color:"#8B0000", collectionType:"Collection", transitType:"By Ship" },
  { id:"3", carrier:"Yodel", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://yodel.co.uk&size=128", serviceName:"Economy Collect", serviceCode:"YO-EC", category:"economy-standard", deliveryDays:"3-4 days", price:3.99, currency:"GBP", features:["Tracked","Collect from local store","Up to 10kg"], rating:3.5, color:"#FF6B00", collectionType:"Drop-off", transitType:"By Ship" },
  { id:"4", carrier:"DHL", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://dhl.com&size=128", serviceName:"Parcel Connect", serviceCode:"DHL-PC", category:"economy-standard", deliveryDays:"1-2 days", price:8.99, currency:"GBP", features:["Full tracking","Real-time updates","Proof of delivery","Up to 30kg"], rating:4.5, isPopular:true, color:"#D40511", collectionType:"Collection", transitType:"By Air" },
  { id:"5", carrier:"UPS", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://ups.com&size=128", serviceName:"Standard", serviceCode:"UPS-STD", category:"economy-standard", deliveryDays:"2-3 days", price:9.49, currency:"GBP", features:["End-to-end tracking","Delivery notifications","Up to 70kg","Insurance included"], rating:4.3, color:"#351C15", collectionType:"Collection", transitType:"By Ship" },
  { id:"6", carrier:"FedEx", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://fedex.com&size=128", serviceName:"Ground", serviceCode:"FX-GRD", category:"economy-standard", deliveryDays:"2-4 days", price:10.99, currency:"GBP", features:["Door-to-door","Signature required","Up to 68kg","Money-back guarantee"], rating:4.4, color:"#4D148C", collectionType:"Collection", transitType:"By Ship" },
  { id:"7", carrier:"DHL", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://dhl.com&size=128", serviceName:"Express Worldwide", serviceCode:"DHL-EW", category:"express", deliveryDays:"Next day by 9am", price:24.99, currency:"GBP", features:["Next day delivery","Before 9am option","Full insurance","Priority handling"], rating:4.8, isFastest:true, color:"#D40511", collectionType:"Collection", transitType:"By Air" },
  { id:"8", carrier:"TNT", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://tnt.com&size=128", serviceName:"Express", serviceCode:"TNT-EXP", category:"express", deliveryDays:"Next day by 12pm", price:19.99, currency:"GBP", features:["Time-definite","Before noon delivery","Real-time tracking","Dedicated courier"], rating:4.6, isPopular:true, color:"#FF6600", collectionType:"Collection", transitType:"By Air" },
  ...
  { id:"10", carrier:"FedEx", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://fedex.com&size=128", serviceName:"Priority Overnight", serviceCode:"FX-PO", category:"express", deliveryDays:"Next day by 10:30am", price:29.99, currency:"GBP", features:["Before 10:30am","Money back guarantee","Full tracking","Fragile handling"], rating:4.7, color:"#4D148C", collectionType:"Drop-off", transitType:"By Air" },
  { id:"11", carrier:"UPS", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://ups.com&size=128", serviceName:"Access Point", serviceCode:"UPS-AP", category:"dropoff", deliveryDays:"2-3 days", price:5.99, currency:"GBP", features:["Drop off at store","7-day collection","Tracking included","Up to 20kg"], rating:4.2, isBestValue:true, color:"#351C15", collectionType:"Drop-off", transitType:"By Ship" },
  { id:"12", carrier:"Parcelforce", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://parcelforce.com&size=128", serviceName:"Drop & Go", serviceCode:"PF-DG", category:"dropoff", deliveryDays:"3-5 days", price:6.49, currency:"GBP", features:["Post Office drop off","Tracked service","Email notifications"], rating:4.0, color:"#003399", collectionType:"Drop-off", transitType:"By Ship" },
  { id:"13", carrier:"Hermes", carrierLogo:"https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://evri.com&size=128", serviceName:"Parcelshop Drop Off", serviceCode:"HE-DO", category:"dropoff", deliveryDays:"2-4 days", price:4.49, currency:"GBP", features:["1000+ locations","Tracked delivery","Up to 15kg"], rating:3.9, color:"#8B0000", collectionType:"Drop-off", transitType:"By Ship" },
];
