...
export default function CsvMappingPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-gray-800">CSV Mapping</h1>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-visible">
        ...
        <div className="p-6">
          {/* Tabs */}
          <div className="flex space-x-2 rounded-xl bg-blue-50 p-1.5 mb-8 max-w-md mx-auto">
            <button
              onClick={() => {
                setActiveTab("new");
                setShowTable(false);
              ...
              className={`w-full rounded-lg py-2.5 text-sm font-semibold leading-5 transition-all duration-200
                ${
                  activeTab === "new"
